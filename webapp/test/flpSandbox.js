		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Main Page to Next Page",
									"targetURL": "#testcomcustomnavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testcomcustomnavigation-display": {
								"semanticObject": "testcomcustomnavigation",
								"action": "display",
								"description": "An SAP Fiori to Navigate from first to Second",
								"title": "Main Page to Next Page",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.com.customnavigation",
									"url": sap.ui.require.toUrl("test/com/customnavigation")
								}
							}
						}
					}
